...
const loadFilmPage = async (name) => {
    ...
    document.getElementById('filmPage').innerHTML += "<div style='display:inline-block;vertical-align:top;width: 50%;text-align: center; margin-top:50px;'><h1 style=''>"+film.Title+"</h1>"+"<h3>"+film.Released+"</h3>"+film.Plot+"</h3>"+"<h1 class='buttonClose'>x</h1>"+"<h3 style='margin-top:50px;'>Actors:<br>"+film.Actors+"</h3>"+"<h3 style='margin-top:50px;'>Imdb rating:<br>"+film.imdbRating+"</h3>"+"<a href ='https://www.imdb.com/title/"+film.imdbID+"'><img style='width:150px; height:40px;' src='IMDB_Logo_2016.png'></a>"+"</div>";
